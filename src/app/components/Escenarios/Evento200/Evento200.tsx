                    ...
                    <>
                        ...
                        <TransformComponent>
                            ...
                            <div className="flex flex-col items-center justify-center -mt-3">
                                ...
                                >
                                    <g>
                                        <g id="onlyAsientos" transform="matrix(0.5,0,0,0.5,-105,20)">
                                            <path
                                                style={{ fill: "#7777ff" }}
                                        ...
                                        <g id="etiquetasAsientos" transform="matrix(0.5,0,0,0.5,-105,20)">
                                            <text
                                                style={{
                                                    fontSize: "10px",
                                                    fill: "#000",
                                        ...
                                        <g id="etiquetasFilas" transform="matrix(0.5,0,0,0.5,-105,20)">
                                            <text
                                                style={{
                                                    fontSize: "40px",
                                                    fill: "#000",
                                        ...
                                        <g id="escenario" transform="matrix(0.5,0,0,0.5,-105,20)">
                                            <path
                                                style={{ fill: "#000" }}
