import { formCrearUsuario } from "@/app/configs/dataforms/dataForms";
...
export const NewEvents = ({ getValues, setValue, control, apiCall }: any) => {

    return (
        <>
            <div className="flex flex-col gap-3">
                {
                    formCrearUsuario?.map((item: any, index: any) => {
                        return (
                            <div key={index}>
                                {
